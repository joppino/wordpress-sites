      ...
      <?php if( get_theme_mod( 'saas_software_technology_date_hide',true) != '' || get_theme_mod( 'saas_software_technology_comment_hide',true) != '' || get_theme_mod( 'saas_software_technology_author_hide',true) != '' || get_theme_mod( 'saas_software_technology_time_hide',true) != '') { ?>
        <div class="metabox py-1 px-2 mb-3">
          ...
          <?php if( get_theme_mod( 'saas_software_technology_comment_hide',true) != '') { ?>
            <span class="entry-comments me-2"><i class="<?php echo esc_attr(get_theme_mod('saas_software_technology_comment_icon', 'fas fa-comments me-1')); ?>"></i> <?php comments_number( __('0 Comments','saas-software-technology'), __('0 Comments','saas-software-technology'), __('% Comments','saas-software-technology') ); ?></span>
          <?php } ?>

          <?php if( get_theme_mod( 'saas_software_technology_time_hide',true) != '') { ?>
           <span class="entry-time me-2"><i class="<?php echo esc_attr(get_theme_mod('saas_software_technology_time_icon', 'fas fa-clock me-1')); ?>"></i> <?php echo esc_html( get_the_time() ); ?></span>
          <?php }?>
        </div>
      <?php } ?>
