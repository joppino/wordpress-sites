			...
			<div class="container">
				<div class="header-box">
		            ...
		            <?php if( get_theme_mod( 'saas_software_technology_site_title',true) != '') { ?>
			            ...
			            <?php endif; ?>
				        <?php }?>
				        <?php if( get_theme_mod( 'saas_software_technology_site_tagline',false) != '') { ?>
			            <?php
						...
						<div class="col-lg-7 col-md-6 col-6 align-self-center px-md-0">
							<div class="menubox <?php if( get_theme_mod( 'saas_software_technology_sticky_header', false) != ''  || get_theme_mod('saas_software_technology_responsive_sticky_header',false) != '') { ?> sticky-header<?php } else { ?>close-sticky <?php } ?>">
								<?php ?>
							   	<div class="toggle-menu responsive-menu text-end">
				           	<button role="tab" onclick="saas_software_technology_menu_open()"><i class="<?php echo esc_attr(get_theme_mod('saas_software_technology_responsive_open_menu_icon','fas fa-bars'));?>"></i><?php echo esc_html( get_theme_mod('saas_software_technology_open_menu_label', __('Open Menu','saas-software-technology'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','saas-software-technology'); ?></span></button>
				         	</div>
				            ...
				            <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'saas-software-technology' ); ?>">
				              ...
				              ?>
				              <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="saas_software_technology_menu_close()"><?php echo esc_html( get_theme_mod('saas_software_technology_close_menu_label', __('Close Menu','saas-software-technology'))); ?><i class="<?php echo esc_attr(get_theme_mod('saas_software_technology_responsive_close_menu_icon','fas fa-times'));?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','saas-software-technology'); ?></span></a>
				            </nav>
				        	</div>
				      	<?php ?>
				      </div>
