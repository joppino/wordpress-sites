 ...
 */
/**
 * Class SAAS_Software_Technology_Customizer_Upsell_Section
 */
class SAAS_Software_Technology_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * SAAS_Software_Technology_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'SAAS_Software_Technology_Customizer_Upsell_Section' );
